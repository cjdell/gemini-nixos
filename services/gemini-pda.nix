...
in
{
  ...
  # Silver side-button SLEEP/WAKE (2026-09-08 — docs/power-sleep.md).
  ...
  # bound: KEY_SLEEP is the wake button. sshd + gemini-battery-guard
  # are never stopped. The daemon debounces presses and drains events
  # queued during a toggle so mashing cannot cascade into flicker.
  #
