        ...
        match chapter {
            ...
            6 => {
                ...
                match t {
                    ...
                    3..=5 => self.text.bottom = Some(("GEMINI PDA / MALI-T880 / NIXOS", fade_in((t as f32 - 3.0) * 3.0, 1.0))),
                    6..=7 => self.text.bottom = Some(("THANK YOU FOR FLYING AETHER", fade_in((t as f32 - 6.0) * 4.0, 1.0) * 0.9)),
                    _ => {}
                }
            }
            _ => {}
