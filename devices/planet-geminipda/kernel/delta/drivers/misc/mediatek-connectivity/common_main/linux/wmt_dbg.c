...
/* 6.6: proc entries use struct proc_ops. One-shot dbg buffer: no seeking. */
static loff_t wmt_dbg_proc_lseek(struct file *filp, loff_t offset, int whence)
{
	return -ESPIPE;
}
