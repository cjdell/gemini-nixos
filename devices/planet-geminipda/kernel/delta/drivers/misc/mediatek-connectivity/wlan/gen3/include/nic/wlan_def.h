...
/* [port 6.6] kernel ACPI headers (pulled in via <linux/fb.h> -> i2c.h ->
 * acpi.h) define ACPI_STATE_D0..D3 as macros; drop them so these enum
 * constants survive. Only safe because the enum names are driver-local. */
#ifdef ACPI_STATE_D0
#undef ACPI_STATE_D0
#endif
#ifdef ACPI_STATE_D1
