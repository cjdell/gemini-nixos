...
| **Bluetooth bring-up** (MT6630 CONSYS BT half: hci_stp port of the vendor 3.18 drv_bt → 6.6, WAK-line wake fix, rx-stall blocker) | **`docs/bluetooth-bringup.md`** (+ `docs/session-log.md` 2026-09-09k; driver in the kernel delta `drv_bt/`) |
